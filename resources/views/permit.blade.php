            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p><a class="btn btn-info" href="javascript:(print())">РАСПЕЧАТАТЬ</a></p>
                        <p><a class="btn btn-info" methods="POST" target="_blank" href="/permit-pdf/ {{ $permit->id }}">СОХРАНИТЬ В PDF</a></p>
                    </div>
                </div>
            </div>
        </div>
